...
class ScaffoldingTagLibTests extends AbstractGrailsTagTests {
    ...
    void testBeanAttributeCanBeAString() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", '${bean.getClass().name}')
    ...
    void testUsesDefaultTemplate() {
		resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", 'DEFAULT FIELD TEMPLATE')
    ...
    void testResolvesTemplateForPropertyType() {
		resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", 'DEFAULT FIELD TEMPLATE')
        resourceLoader.registerMockResource("/grails-app/views/fields/java.lang.String/_field.gsp", 'PROPERTY TYPE TEMPLATE')
    ...
    void testResolvesTemplateForDomainClassProperty() {
		resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", 'DEFAULT FIELD TEMPLATE')
        resourceLoader.registerMockResource("/grails-app/views/fields/java.lang.String/_field.gsp", 'PROPERTY TYPE TEMPLATE')
        resourceLoader.registerMockResource("/grails-app/views/fields/person/name/_field.gsp", 'CLASS AND PROPERTY TEMPLATE')
    ...
    void testBeanAndPropertyAttributesArePassedToTemplate() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", '${bean.getClass().name}.${property}')
    ...
    void testConstraintsArePassedToTemplate() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", 'nullable=${constraints.nullable}, blank=${constraints.blank}')
    ...
    void testLabelIsResolvedByConventionAndPassedToTemplate() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", '<label>${label}</label>')
    ...
    void testValueIsDefaultedToPropertyValue() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", '<g:formatDate date="${value}" format="yyyy-MM-dd"/>')
    ...
    void testValueIsOverriddenByValueAttribute() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", '${value}')
    ...
    void testErrorsPassedToTemplateIsAnEmptyCollectionForValidBean() {
        resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", '<g:each var="error" in="${errors}"><em>${error}</em></g:each>')
    ...
    void testResolvesTemplateForEmbeddedClassProperty() {
		resourceLoader.registerMockResource("/grails-app/views/fields/default/_field.gsp", 'DEFAULT FIELD TEMPLATE')
        resourceLoader.registerMockResource("/grails-app/views/fields/java.lang.String/_field.gsp", 'PROPERTY TYPE TEMPLATE')
        resourceLoader.registerMockResource("/grails-app/views/fields/address/city/_field.gsp", 'CLASS AND PROPERTY TEMPLATE')
